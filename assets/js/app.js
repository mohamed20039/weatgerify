...
export const updateWeather = function (lat, lon) {
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    fetchData(url.reverseGeo(lat, lon), function ([{ name, country }]) {
      let cardText = card.querySelector("[data-location]").innerHTML = `${name}, ${country}`;

      let msg = new SpeechSynthesisUtterance(cardText)
    ...
    fetchData(url.forecast(lat, lon), function (forecast) {
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        const cardText = tempLi.textContent;

          
        let msger = new SpeechSynthesisUtterance(cardText)
          
        speechSynthesis.speak(msger)
        ...
        const cardText2 = windLi.textContent;

        console.log(cardText2)
          
        let msg = new SpeechSynthesisUtterance(cardText2)
...
// const { hourlySection , tempLi , card , windLi , forecastSection , li} = updateWeather || {};

// hourlySection.querySelectorAll("h1 , h2 , h3 , h4 , h5 , h6 , p")

// tempLi.querySelectorAll("h1 , h2 , h3 , h4 , h5 , h6 , p")


// windLi.querySelectorAll("h1 , h2 , h3 , h4 , h5 , h6 , p")

// forecastSection.querySelectorAll("h1 , h2 , h3 , h4 , h5 , h6 , p")

// li.querySelectorAll("h1 , h2 , h3 , h4 , h5 , h6 , p")
